...
class MagazinesSectionController extends Controller
{
    public $common;
    ...
    public function index()
    {
        try {
            ...
            $params['data'] = Content_Section::where('section_type', 3)->orderBy('sort_order', 'asc')->latest()->get();
            ...
            return view('admin.magazines_section.index', $params);
        } catch (Exception $e) {
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (isset($data->id)) {
                return response()->json(['status' => 200, 'success' => __('label.success_add_magazines_section')]);
            } else {
                return response()->json(['status' => 400, 'errors' => __('label.error_add_magazines_section')]);
            }
        } catch (Exception $e) {
            return response()->json(['status' => 400, 'errors' => $e->getMessage()]);
        }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data = Content_Section::updateOrCreate(['id' => $requestData['id']], $requestData);
            if (isset($data->id)) {
                return response()->json(['status' => 200, 'success' => __('label.success_edit_magazines_section')]);
            } else {
                return response()->json(['status' => 400, 'errors' => __('label.error_edit_magazines_section')]);
            }
        } catch (Exception $e) {
            return response()->json(['status' => 400, 'errors' => $e->getMessage()]);
        }
    ...
    public function show($id)
    {
        try {
            ...
            return response()->json(['status' => 200, 'success' => __('label.magazines_section_delete')]);
        } catch (Exception $e) {
            return response()->json(['status' => 400, 'errors' => $e->getMessage()]);
        }
    }
