    ...
    public function handle(Request $request, Closure $next)
    {
        try {
            ...
            if ($verflyDomain == 1) {
                ...
                // Skip installer when DB already contains an admin user row.
                // This prevents needing PURCHASE_CODE / BUYER_USERNAME to be set.
                try {
                    ...
                    // If the DB check fails for any reason, fall back to purchase-code logic.
                }
