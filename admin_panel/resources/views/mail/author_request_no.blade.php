                        ...
                        <td style="padding: 30px; color: #000000;">
                            <div style="font-size: 18px; line-height: 1.7;">
                                <p style="margin-bottom: 20px;">
                                    We appreciate your interest in becoming a tutor on <strong>{{ App_Name() }}</strong>.<br><br>
                                    After careful review, we regret to inform you that your tutor request has been <strong style="color: red;">Rejected</strong> at this time.
                                </p>
