    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            ...
            <div class="col-sm-1 d-flex justify-content-start mb-3">
                <button type="button" data-toggle="modal" data-target="#sortOrderModal" onclick="sortOrderBTN()" class="btn btn-default br-10">
...
<script>
    ...
    function sortOrderBTN() {
        ...
        for (var i = 0; i < language_data.length; i++) {
            htmlContent += '<div id="' + language_data[i].id + '" class="listitemClass mb-2 cursor">' +
