        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('label.novels')}}</li>
                </ol>
            </div>
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('admin.novels.create') }}" class="btn btn-default mw-120 mb-3">{{__('label.add_novel')}}</a>
            </div>
        </div>
...
<script>
    ...
    function change_status(id) {
        ...
        if (Demo_Mode == 1) {
            ...
            $("#dvloader").show();
            var url = `{{ route('admin.novels.show', '') }}/${id}`;
