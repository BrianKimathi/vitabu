                    ...
                    <div class="form-row">
                        <div class="col-md-9">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Publisher's Author Name (Optional)</label>
                                        <input type="text" name="publisher_author_name" class="form-control" placeholder="Author Name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col-12">
                                    <small class="text-muted">Leave both empty to use the default commission rate from App Settings. If both set, percentage takes priority.</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        if (Demo_Mode == 1) {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_novel', '{{ route("admin.novels.index") }}');
                },
