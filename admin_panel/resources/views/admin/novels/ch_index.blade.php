    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('admin.novels.index') }}" class="btn btn-default mw-120 mb-3">{{__('label.novels')}}</a>
            </div>
        </div>

        <!-- Search -->
        <form action="{{ route('admin.novels.chapters.index', $novel_id)}}" method="GET">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                <a href="{{ route('admin.novels.chapters.add', $novel_id) }}" class="add-video-btn">
                    ...
                    <div class="position-relative">
                        ...
                        <ul class="list-inline overlap-control">
                            <li class="list-inline-item">
                                <a class="btn" href="{{route('admin.novels.chapters.edit', [$novel_id, $value->id])}}">
                                    <i class="fa-solid fa-pen-to-square fa-xl primary-color"></i>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a class="btn" href="{{route('admin.novels.chapters.delete', [$novel_id, $value->id])}}" onclick="return confirm('{{ __('label.delete_chapter') }}')">
...
<script>
    ...
    function save_chapter_sortorder() {
        ...
        if (Check_Admin == 1) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("admin.novels.chapters.sortorder") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_chapter_sortorder', '{{ route("admin.novels.chapters.index", $novel_id)}}');
                },
