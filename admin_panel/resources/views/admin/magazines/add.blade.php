...
@section('page_title', __('label.add_magazines'))
@section('tab_title', __('label.add_magazines'))
...
<div class="right-content">
    ...
    <div class="body-content">
        <!-- mobile title -->
        <h1 class="page-title-sm">{{__('label.add_magazines')}}</h1>
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('label.add_magazines')}}</li>
                </ol>
            </div>
        ...
        <div class="card custom-border-card">
            <div class="card-body py-0">
                <form id="save_magazines" enctype="multipart/form-data">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="d-block">
                                            <label>{{__('label.upload_magazine')}}<span class="text-danger">*</span></label>
                    ...
                    <div class="border-top pt-3 text-right">
                        <button type="button" class="btn btn-default mw-120" onclick="save_magazines()">{{__('label.save')}}</button>
...
<script>
    ...
    // Save Magazines
    function save_magazines() {

        var Demo_Mode = '<?php echo Demo_Mode(); ?>';
        if (Demo_Mode == 1) {

            $("#dvloader").show();
            var formData = new FormData($("#save_magazines")[0]);
            $.ajax({
                type: 'POST',
                url: '{{ route("admin.magazines.store") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_magazines', '{{ route("admin.magazines.index") }}');
                },
