...
@section('tab_title', 'Edit Sub-Admin')
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Edit Sub-Admin</h1>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user_name" value="{{ $data->user_name }}" class="form-control" placeholder="Enter Username" autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="role" class="form-control">
                                        ...
                                        <option value="accounts" {{ $data->role === 'accounts' ? 'selected' : '' }}>Accounts</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="border-top pt-3 text-right">
                            <button type="button" class="btn btn-default mw-120" onclick="save_subadmin()">{{__('label.update')}}</button>
    ...
    <script>
        function save_subadmin() {
            ...
            if (Demo_Mode == 1) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("admin.subadmin.update", $data->id) }}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
