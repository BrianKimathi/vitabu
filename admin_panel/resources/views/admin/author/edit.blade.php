...
@section('page_title', __('label.edit_author'))
@section('tab_title', __('label.edit_author'))
...
<div class="right-content">
    ...
    <div class="body-content">
        <!-- mobile title -->
        <h1 class="page-title-sm">{{__('label.edit_author')}}</h1>
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('label.edit_author')}}</li>
                </ol>
            </div>
            ...
            <div class="card-body">
                <form id="update_author" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ifsc_code" value="{{ $data['ifsc_code'] ?? '' }}" class="form-control" placeholder="{{__('label.ifsc_code_here')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-top pt-3 text-right">
                        <button type="button" class="btn btn-default mw-120" onclick="update_author()">{{__('label.update')}}</button>
...
<script>
    ...
    function update_author() {
        ...
        if (Demo_Mode == 1) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("admin.author.update", [ $data->id ]) }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'update_author', '{{ route("admin.author.index") }}');
                },
