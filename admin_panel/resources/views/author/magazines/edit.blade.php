        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('author.magazines.index') }}">{{__('label.magazines')}}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{__('label.edit_magazines')}}</li>
                </ol>
            </div>
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('author.magazines.index') }}" class="btn btn-default mw-120 mb-3">{{__('label.magazines_list')}}</a>
            </div>
        </div>
            ...
            <div class="card-body py-0">
                <form id="edit_magazines" enctype="multipart/form-data">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="d-block">
                                            <label>{{__('label.upload_magazines')}}</label>
                    ...
                    <div class="border-top pt-3 text-right">
                        ...
                        <a href="{{route('author.magazines.index')}}" class="btn btn-cancel mw-120 ml-2">{{__('label.cancel')}}</a>
...
<script>
    ...
    function edit_magazines() {
        ...
        if (Demo_Mode == 1) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("author.magazines.update", [$data->id]) }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'edit_magazines', '{{ route("author.magazines.index") }}');
                },
