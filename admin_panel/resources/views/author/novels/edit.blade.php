                    ...
                    <div class="form-row">
                        <div class="col-md-9">
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="col-12">
                                    <small class="text-muted">Leave empty to use default commission rate.</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
...
<script>
    ...
    function edit_novel() {
        ...
        if (Demo_Mode == 1) {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("author.novels.update", [$data->id]) }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'edit_novel', '{{ route("author.novels.index") }}');
                },
